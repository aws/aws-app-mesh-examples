...
aws ec2 create-security-group --group-name yelb-es-security-group --description "Security Group for Yelb-ElastiCache" --vpc-id ${VPC_ID}
...
aws elasticache create-cache-cluster \
    --cache-cluster-id "yelb-elasticache-cluster" \
    --engine redis \
