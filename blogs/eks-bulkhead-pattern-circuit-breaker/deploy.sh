...
PRICE_APP_IMAGE="${ECR_IMAGE_PREFIX}/${APP}"
...
deploy_app() {
    ...
    eval "cat <<EOF
$(<${DIR}/manifests/base.template.yaml)
EOF
" >${EXAMPLES_OUT_DIR}/base.yaml

    eval "cat <<EOF
$(<${DIR}/manifests/update.template.yaml)
EOF
" >${EXAMPLES_OUT_DIR}/update.yaml

    kubectl apply -f ${EXAMPLES_OUT_DIR}/base.yaml
}
