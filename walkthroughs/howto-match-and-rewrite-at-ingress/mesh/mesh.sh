...
main() {
    ...
    up)
        ...
        ;;
    configure-query-parameter-match-rewrite)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-rewrite.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_route "${TEST_MESH_DIR}/colorteller-route-updated-rewrite.json" "colorteller-vr-1" "colorteller-route-1"
        ;;
    disable-default-prefix-rewrite)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-disabled_rewrite.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_route "${TEST_MESH_DIR}/colorteller-route-updated-rewrite.json" "colorteller-vr-1" "colorteller-route-1"
        ;;
    configure-hostname-match)
        update_gateway_route "${TEST_MESH_DIR}/colorgateway-route-updated-hostname-match.json" "colorgateway-vg" "colorgateway-route-1" "colorteller-1.${SERVICES_DOMAIN}"
        update_route "${TEST_MESH_DIR}/colorteller-route-1.json" "colorteller-vr-1" "colorteller-route-1"
        ;;
    down)
