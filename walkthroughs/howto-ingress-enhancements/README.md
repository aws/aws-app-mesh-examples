...
In this walkthrough we'll extend our existing [ColorApp](https://github.com/aws/aws-app-mesh-examples/tree/master/examples/apps/colorapp) example with a GatewayRoute resource and configure Hostname Matching, Query Parameter Matching, Enabling and Disabling of Prefix Rewrites.
