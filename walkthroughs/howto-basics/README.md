...
2. Adopt App Mesh for service to service communication via Envoy proxy. This will build on Cloud Map service discovery integration and show how App Mesh helps address the observability needs via Cloud Watch integration.
