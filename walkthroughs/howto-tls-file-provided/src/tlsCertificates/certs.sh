...
generate_rsa_key colorteller_white ca_1
generate_x509_cert colorteller_white ca_1
generate_cert_chain colorteller_white ca_1

# Generate cert for the green color teller.
echo "Generating frontend certificate."
generate_rsa_key colorteller_green ca_2
generate_x509_cert colorteller_green ca_2
generate_cert_chain colorteller_green ca_2
