...
case "$action" in
up)
    FRONT_APP_CA_CERT=ca_1_cert.pem
    FRONT_APP_K8S_SECRET=front-ca1-tls
    ;;
addGreen)
    FRONT_APP_CA_CERT=ca_1_ca_2_bundle.pem
    FRONT_APP_K8S_SECRET=front-ca1-ca2-tls
    ;;
removeGreen)
    FRONT_APP_CA_CERT=ca_1_cert.pem
    FRONT_APP_K8S_SECRET=front-ca1-tls
...
PROJECT_NAME="howto-k8s-mtls-file-based"
