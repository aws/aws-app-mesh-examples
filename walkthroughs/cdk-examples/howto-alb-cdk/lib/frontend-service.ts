...
export class FrontEndServiceConstruct extends Construct {
    ...
    constructor(ms: MeshStack, id: string) {
        ...
        const envoyContainer = this.taskDefinition.addContainer(`${this.prefix}EnvoyContainer`, {
            ...
            containerName: 'envoy',
            logging: ecs.LogDriver.awsLogs({ logGroup: ms.sd.base.logGroup, streamPrefix: 'front-envoy' }),
            environment: {
        ...
        const xrayContainer  = this.taskDefinition.addContainer(`${this.prefix}XrayContainer`, {
            ...
            containerName: 'xray',
            logging: ecs.LogDriver.awsLogs({ logGroup: ms.sd.base.logGroup, streamPrefix: 'front-xray' }),
            user: '1337'
        });
        ...
        const appContainer = this.taskDefinition.addContainer(`${this.prefix}Container`, {
            ...
            logging: ecs.LogDriver.awsLogs({ logGroup: ms.sd.base.logGroup, streamPrefix: 'front-app' }),
            environment: {
