...
export class ServiceDiscoveryStack extends Stack {
    ...
    constructor(base: BaseStack, id: string, props?: StackProps) {
        ...
        this.backendV1LoadBalancer = new elbv2.ApplicationLoadBalancer(this, 'BackendV1LoadBalancer', {
        ...
        this.backendRecordSet = new route53.RecordSet(this, 'BackendRecordSet', {
            ...
            target: route53.RecordTarget.fromAlias(new LoadBalancerTarget(this.backendV1LoadBalancer)),
            recordName:`backend.${this.base.dnsHostedZone.zoneName}`
        });

        // CloudMap registry for backend service v2
        this.backendV2CloudMapService = this.base.dnsNameSpace.createService(`BackendV2CloudMapService`, {
            name: 'backend-v2',
        ...
        this.frontendLoadBalancer = new elbv2.ApplicationLoadBalancer(this, 'FrontendLoadBalancer', {
